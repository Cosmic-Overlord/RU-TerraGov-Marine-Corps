...
GLOBAL_LIST_INIT(runedsandstone_recipes, list ( \
	...
	new/datum/stack_recipe("sandstone floor tile", /obj/item/stack/tile/plasteel/sandstone/runed, req_amount = 2, res_amount = 4, time = 2 SECONDS, skill_req = SKILL_CONSTRUCTION_MASTER), \
