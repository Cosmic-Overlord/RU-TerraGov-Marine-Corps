...
/obj/item/scalp/Initialize(mapload, mob/living/carbon/human/scalpee, mob/living/carbon/human/user)
	...
	var/image/blood_overlay = image('modular_RUtgmc/icons/obj/items/hunter/pred_gear.dmi', "scalp_[variant]_blood")
...
/obj/item/skull
	name = "skull"
	icon = 'modular_RUtgmc/icons/obj/items/hunter/xeno_skulls.dmi'
