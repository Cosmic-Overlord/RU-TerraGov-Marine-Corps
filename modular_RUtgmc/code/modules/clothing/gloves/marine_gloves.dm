...
/obj/item/clothing/gloves/marine/veteran/examine(mob/user)
	. = ..()
	. += span_info("You could <b>use it in-hand</b> to turn it inside out and change it's appearance.")

/obj/item/clothing/gloves/marine/veteran/attack_self(mob/user)
	. = ..()
...
/obj/item/clothing/gloves/marine/veteran/update_icon_state()
	if(gloves_inside_out)
