...
/datum/job/terragov/command/casofficer/radio_help_message(mob/M)
	. = ..()
	to_chat(M, {"Your job is to pilot the Condor, a modular attack aircraft that provides close air support with a variety of weapons ranging from the inbuilt gatling to wing mounted rockets.."})
