...
//#define INIT_ORDER_EXPLOSIONS -69 // RUTGMC REMOVED - Explosions
...
//#define FIRE_PRIORITY_EXPLOSIONS 666 //RUTGMC DELETION - Explosions
#define FIRE_PRIORITY_CELLAUTO 666 //RUTGMC ADDITION - Explosions
