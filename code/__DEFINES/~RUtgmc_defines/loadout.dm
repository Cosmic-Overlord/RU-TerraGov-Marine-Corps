...
GLOBAL_LIST_INIT(leader_gear_listed_products, list(
		...
		/obj/effect/vendor_bundle/mimir/two = list(CAT_LEDSUP, "Mark 2 Mimir Resistance set", 25, "white"),
		/obj/effect/vendor_bundle/tyr/two = list(CAT_LEDSUP, "Mark 2 Tyr extra armor set", 25, "white"),
