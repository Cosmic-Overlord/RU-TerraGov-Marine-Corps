GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		...
		/obj/item/storage/box/crate/minisentry = list(CAT_ENGSUP, "ST-580 point defense sentry kit", 50, "blue"),
		...
		/obj/item/tool/pickaxe/plasmacutter = list(CAT_ENGSUP, "Plasma cutter", 20, "blue"),
...
GLOBAL_LIST_INIT(commander_gear_listed_products, list(
		...
		/obj/item/storage/pouch/medical_injectors/medic = list(CAT_FCSUP, "Advanced Injector Pouch", 23, "cyan"),
